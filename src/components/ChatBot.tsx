...
const ChatBot = ({ isOpen, onToggle }: ChatBotProps) => {
  ...
  const getBotResponse = (userMessage: string): string => {
    ...
    if (lowerMessage.includes('телефон') || lowerMessage.includes('контакт') || lowerMessage.includes('связаться')) {
      return 'Бесплатная горячая линия: +7 (999) 095-55-59 (круглосуточно). Также можете оставить заявку на сайте в разделе "Контакты".';
    }
    ...
    if (lowerMessage.includes('спасибо')) {
      return 'Пожалуйста! Если возникнут еще вопросы - обращайтесь. Или звоните на горячую линию +7 (999) 095-55-59.';
    }

    return 'Извините, я не совсем понял ваш вопрос. Попробуйте спросить о: выплатах, гражданстве, требованиях, документах, льготах, специальностях или контактах. Или позвоните на горячую линию +7 (999) 095-55-59.';
  };
